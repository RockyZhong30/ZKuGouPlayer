#include "zsingleapplication.h"
#include <QFileInfo>
#include<QLocalSocket>
#define TIME_OUT                (500)

ZSingleApplication::ZSingleApplication(int &argc, char **argv):QApplication(argc, argv)
    , w(NULL)
    , _isRunning(false)
    , _localServer(NULL)
{
...
bool ZSingleApplication::isRunning()
{
     return _isRunning;
}
 ...
 ////////////////////////////////////////////////////////////////////////////////
 void ZSingleApplication::_newLocalConnection()
 {
 ...
 ////////////////////////////////////////////////////////////////////////////////
 void ZSingleApplication::_initLocalConnection()
 {
     _isRunning = false;
 ...
 // 创建LocalServer
 ////////////////////////////////////////////////////////////////////////////////
 void ZSingleApplication::_newLocalServer()
 {
 ...
 // 激活主窗口
 ////////////////////////////////////////////////////////////////////////////////
 void ZSingleApplication::_activateWindow()
 {
     if(w)
     {
         w->showNormal();
